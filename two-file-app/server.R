...
server <- function(input, output) {
  ...
  trout_filtered_df <- reactive({
    ...
    #refining 
    validate(
      #give true and false statement to make sure a channel type is selected in app
  ...
  alt = "This is my alt text and it's not very good right now but we will improve later"
  
  ) 
  
  
  #filter island penguin data ----
  island_df <- reactive ({ 
